...
/*   Updated: 2024/12/05 19:15:47 by pehenri2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					calculate_texture_x(int screen_x, t_sprite *sprite,
						mlx_texture_t *texture);
int					calculate_texture_y(int screen_y, t_game *game,
						t_sprite *sprite, mlx_texture_t *texture);
